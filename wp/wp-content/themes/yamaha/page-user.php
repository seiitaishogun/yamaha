            ...
            <div class="main-info">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab-user" role="tablist">
                        ...
                        <a class="nav-link" id="freecoupon-tab" data-toggle="tab" href="#freecoupon" role="tab" aria-controls="freecoupon" aria-selected="false"><img src="<?php echo get_template_directory_uri() ?>/img/ic_free_coupon.svg" alt="" />&nbsp&nbspPhiếu giảm giá</a>
                    </div>
                </nav>
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="freecoupon" role="tabpanel" aria-labelledby="freecoupon-tab">
                        <?php require_once( CCMS_ABSPATH.'/html/customer/free-coupon.php' ); ?>
                    </div>
                </div>
            </div>
    </div>
