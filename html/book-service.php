...
<div class="bgGray">
    <div class="container-fluid">
        <div class="wrapper-container wrapper-container--sm">
            ...
            <h5 class="ff-1 colorDark text-uppercase">Book a service</h5>
            <div style="height: 16px;"></div>
                ...
                <div class="box-white customer-info">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-right">
                            <a href="javascript:void(0);" class="btn-clip btn-red btn-buy-now" data-toggle="modal" data-target="#staticBackdrop">BOOK NOW</a>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="title text-uppercase">Book a service</div>
                ...
                <div class="customer-info">
                    ...
                    <div class="info-item">
                        <img src="./img/buy-apparel/service.svg" alt="" />
                        <div class="info-item__content">
                            <label>Service</label>
                            <p>Service A</p>
                        </div>
