...
<script type="text/javascript">
	var product_code='<?=$product_code?>', color_code='', size='', size_code='', color='', color_name='',  size_name='', price=<?=$price?>, sale_off=<?=$sale_off?>, price_old=<?=$price_old?>, dealer_id = '', dealer_name='', dealer_address='', quantity=1, image = '' ;
