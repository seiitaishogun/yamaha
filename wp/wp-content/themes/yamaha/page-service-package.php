                                                ...
                                                <div class="block-service">
                                                    ...
                                                    <div class="d-md-flex justify-content-between w-100">
                                                        <div class="info">
                                                            ...
                                                            <p class="price"><?php echo currencyFormat(get_field('price', $e->ID)); ?>
                                                            <?php if (get_field('price_old', $e->ID) > 0) {?>
                                                                <span class="price_old"><?=currencyFormat(get_field('price_old', $e->ID))?></span>
                                                            <?php } ?>
                                                            </p>
                                                        </div>
