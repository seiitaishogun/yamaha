...
<head>
    ...
    <script type="text/javascript">
        ...
        var url_return = "<?php echo esc_url(home_url('/')) ?>";

        <?php if (!isset($_COOKIE["uid"])) : ?>
            var cookie_uid = Cookies.set("uid", '<?php echo uniqid(); ?>', {
                expires: 365 * 10
            });
        <?php endif; ?>
    </script>
    ...
    <header class="h-box <?php echo $page_id !== 5 ? '' : 'gradient' ?>">
        <div class="container-fluid h-box__wrapper">
            <a href="<?php echo get_permalink(5) ?>" class="h-logo">
                <img src="<?php echo get_template_directory_uri() ?>/img/logo.png" alt="" class="h-logo-new">
                        ...
                        <form action="/examples/actions/confirmation.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group" >                    
                                    <input type="password" class="form-control tmt-pass" required="required">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn tmt-login btn-primary btn-block" value="Login">
                            </div>
                        </form>
                        <div class="form-group text-center mt-0 pt-0 mb-0 pb-0">
                            <a href="#" class="tmt-link"><small>Forgot Password? Click here!</small></a>
                            <br>
                            <p class="mt-2" style="color: #7A7C7E; font-size:14px;">OR</p>
                        </div>
