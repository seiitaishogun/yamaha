...
<?php /*?>
<div class="book-service" style="background-color: #333333; margin-bottom: 0px !important; padding-top: 60px;">
                                ...
                                <div class="dropdown dropdown-dealer dropdown--selected filter-dealer">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <?php foreach ($dealer as $e) : ?>
                                            <a class="dropdown-item" href="javascript:void(0)" data-code="<?php echo get_field("dealer_code", $e->ID) ?>" data-name="<?php echo get_the_title($e->ID); ?>" data-address="<?php echo get_field("address", $e->ID); ?>">
...
<div class="service-plan" id="section_service_package">
    <?php
...
<div class="image-text" id="section_rescue_247">
    <?php
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", "#booking", function() {
            ...
            data = {
                ...
                dealer_code: filter_dealer['dealer_code'],
                message: message,
            }
