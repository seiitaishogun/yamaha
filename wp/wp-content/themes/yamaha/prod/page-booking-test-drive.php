                ...
                <div class="box-white customer-info">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-right">
                            <button type="submit" class="btn-clip btn-red" style="min-width: 140px">XEM TRƯỚC VÀ ĐẶT XE</button>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <a href="javascript: void(0);" class="btn btn-link btn-link-red" data-dismiss="modal">HỦY BỎ</a>
                    <a href="javascript: void(0)" class="btn-clip btn-red btn-buy-now" id="booking-bike">ĐẶT LỊCH</a>
                </div>
            </div>
        </div>
    </div>
