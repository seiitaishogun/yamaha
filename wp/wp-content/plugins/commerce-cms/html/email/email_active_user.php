...
<table id="Table_01" width="640" border="0" cellpadding="0" cellspacing="0" style="margin: auto;font-family: 'Montserrat', sans-serif;">
	<tr >
		<td>
			<div style="background-color: #ffffff;padding: 10px;border-radius: 6px;">
				<p>
					<b>Thân chào Quý khách,</b></p>
				<p>
					Vui lòng nhấn vào link bên dưới để thực hiện xác thực thông tin tài khoản của Quý khách tại <a href="<?= $data['url'] ?>">đây</a>
				</p>
				<p>
					Vui lòng không chia sẻ link này cho người khác.
				</p>
				<p>
					<b>Lưu ý:</b> Nếu Quý khách không thực hiện xác thực thông tin nhưng vẫn nhận được email này, thì nên thay đổi mật khẩu ngay!
				</p>
				<p>
					Trân trọng,<br/>
					Revzone Yamaha Motor team.
				</p>				
			</div>
		</td>
	</tr>
	<tr >
		<td>
			<div class="color-blue" style="margin-top:30px;">
				<div>
