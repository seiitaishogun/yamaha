...
<section class="cat-banner banner-single">
 ...
 <?php 
    ...
    $sale_off = intval(str_replace(".","", $sale_off)); 
                        ...
                        <div class="dropdown filter-dealer">
                            ...
                            <div id="dealerSelect" class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <?php foreach ($post_dealers as $e) : ?>
                                    <a class="dropdown-item" href="javascript:void(0)" data-dealer_id="<?php echo $e->ID; ?>" data-name="<?php echo get_the_title($e->ID); ?>" data-address="<?php echo get_field("address", $e->ID); ?>" data-dealer_code="<?php echo get_field("dealer_code", $e->ID); ?>">
...
<script type="text/javascript">
	 var product_code = '<?=$product_code?>', dealer_id = '', dealer_code=''; dealer_address='', dealer_name='', color='', size='', color_code='', color_name='', size_code='', size_name='',  price = <?=$price?> , price_old = <?=$price_old?>, sale_off = <?=$sale_off?>, promotion_code = '';
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.filter-dealer .dropdown-item', function() {
            ...
            dealer_code = that.attr('data-dealer_code');
