    ...
    ?>
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo get_permalink(420); ?>" class="fz14 colorRed text-uppercase bold d-xl-flex d-lg-flex align-items-center">XEM TẤT CẢ <span style="width: 14px"></span> <i class="ico__chev-right"></i></a>
            </div>
            <div class="description">
            ...
            <div class="row row-32 flex-md-row-reverse flex-column-reverse">
                <div class="col-md-5 align-self-center">
                    <div class="content">
                        ...
                        <a href="<?php echo get_permalink(415); ?>" class="btn-clip btn-border-red">Xem thêm <span class="ico__chev-right"></span></a>
                    </div>
                </div>
                <div class="col-md-7">
                    <div class="image">
