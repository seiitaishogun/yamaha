                        ...
                        ?>
                            <div class="product-item has-pick" id="bike-<?php echo $bike_id; ?>">
                                ...
                                <div class="content">
                                    ...
                                    <p class="price mb-0">Giá từ <span><?php echo currencyFormat($list_colors[0]['price_color'], ' ₫') ?> </span></p>
                                </div>
                            ...
                            <?php foreach ($categories as $key => $_m) : ?>
                                ...
                                <div class="<?php echo $key === 0 ? 'h-menu__section active' : 'h-menu__section' ?>">
                                    <div class="row">
                                        ...
                                        ?>
                                            <div class="col-6">
                                                <a href="javascript: void(0)" data-id="<?php echo $post->ID ?>" data-title="<?php echo get_the_title(); ?>" data-img="<?php echo $group['feature_img']; ?>" data-price="<?php echo currencyFormat($price); ?>" data-spec='<?php echo json_encode($spec); ?>' class="stretched-link get-item"></a>
