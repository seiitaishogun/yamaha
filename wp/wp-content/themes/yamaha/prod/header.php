                ...
                foreach ($_menus[0] as $v) {
                    if (isset($_menus[$v->ID])) {
                        ...
                        if (in_array("menu-product", $v->classes)) {
                            ...
                            echo '</ul></div>';
                        } else { // h-menu__item--submenu
                            echo '<li class="h-menu__item  d-lg-flex d-xl-flex d-none' . ($v->object_id == $page_id ? 'active' : '') . '">
                                    <h6><a href="' . $v->url . '" class="link">' . $v->title . '</a></h6>';   
                            //echo '        <div class="h-menu__submenu menu-dichvu sub_menu_dichvu" id="menu_dichvu">
                            //            <ul class="h__list">';  
        ...
        foreach ($_menus[0] as $k => $v) {
            ...
            if (isset($_menus[$v->ID])) {
                if (in_array("menu-product", $v->classes)) {
                    ...
                    //echo '               <span class="chevron-right" data-toggle="collapse" data-target="#collapse_h' . $v->ID . '" aria-expanded="false" aria-controls="collapse_h' . $v->ID . '"></span>
                    echo '            </div>';
                    //echo '      <div id="collapse_h' . $v->ID . '" class="collapse sub_menu_dichvu"><ul class="h__list">';
