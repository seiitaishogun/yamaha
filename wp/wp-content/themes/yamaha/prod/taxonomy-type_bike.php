                ...
                <div class="right-content full-mb">
                    <div class="top-detail">
                        ...
                        <div class="group-dropdown">
                            ...
                            ?>
                            <div class="dropdown dropdown--selected filter-package">
                            ...
                            <div class="dropdown dropdown--selected">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <?php foreach ($term_type as $k => $item) : ?>
                                        <a class="dropdown-item" href="<?php echo get_term_link($item->term_id); ?>" data-val="action"><?php echo $item->name; ?></a>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '.filter-package .dropdown-item', function() {
            var that = $(this);
            var text = that.text();
            var filter = that.attr('data-filter');

            $(".filter-package .title").text(text);
