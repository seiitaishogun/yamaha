...
<script type="text/javascript">
     var product_code = '<?=$product_code?>', dealer_id = '', dealer_code=''; dealer_address='', dealer_name='', color='', size='', color_code='', color_name='', size_code='', size_name='',  price = <?=$price?> , price_old = <?=$price_old?>, sale_off = <?=$sale_off?>;
