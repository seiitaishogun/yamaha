...
<section class="my-orders container-fluid bg-white py-5">
        ...
        <div class="col-lg-8">
            ...
            <div class="info-follow-order text-center mt-4">
                    ...
                    <? /*
                        ...
                        */
                        ?>
                    <div class="status-order mt-3 mb-4 status-4" >
                        <? /*
                        status-text-1
                        status-text-2
                        status-text-3
                        ...
                        */
                        ?>
                        <p class="status-text-2">Đã giao hàng</p> 
                    </div>
        ...
        <div class="col-lg-8">
            ...
            <div class="info-follow-order text-center mt-4">
                    ...
                    <? /*
                        ...
                        */
                        ?>
                    <div class="status-order mt-3 mb-4 status-1" >
                        <? /*
                        status-text-0
                        status-text-1
                        status-text-2
                        ...
                        */
                        ?>
                        <p class="status-text-1">Đã giao hàng</p> 
                    </div>
