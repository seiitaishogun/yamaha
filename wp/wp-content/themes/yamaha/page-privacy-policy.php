        ...
        <div class="row">
            <div class="left-content">
                <ul class="list-item">
                    ...
                    <li data-title="Chính Sách Bảo Mật" class="active"><a href="<?php the_permalink(494) ?>">Chính Sách Bảo Mật</a></li>
                    <li data-title="Chính Sách Cookies"><a href="<?php the_permalink(498) ?>">Chính Sách Cookies</a></li>
